...
2026-09-02 e reafirmado pelo fechamento do ticket
[032](wayfinder/tickets/032-catalogo-do-maino-e-planilha-de-arquiteto.md), que decidiu não
buscá-lo). Na fase 1 o "catálogo" do agente é: as **categorias e o posicionamento** da loja
no contexto (ver **A loja**) + o **site** como referência de estilo, que ele compartilha com
o cliente mas não consulta em runtime. Produto específico → escala. **Catálogo não é
disponibilidade.**
