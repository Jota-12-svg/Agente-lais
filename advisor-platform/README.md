...
| `web/` | login Google, guarda de allow-list, fila ao vivo (Realtime), assumir, finalizar chamado, protótipo visual do freio de mão global (036, não funcional) | migração aplicada + provider Google no Supabase Auth |
