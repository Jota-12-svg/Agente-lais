...
status: closed
assignee: claude-session-2026-09-02
blocked-by: ["009", "003"]
---
...
033) ou pelo polling do Mainô: `virou_venda` · `virou_visita` · `sem_venda` · `perdido`.
...
| `virou_visita`, confirmação de venda, `advisor_verdict`, tom | consultora | **manual**, um canal só, atrito quase zero — ver ticket [033](033-superficie-das-consultoras-para-o-agente.md) |
...
consultora faz isso é o ticket [033](033-superficie-das-consultoras-para-o-agente.md). Pode
...
033 e o [014](014-como-o-agente-soa.md), não um bloqueio.
...
- **Adesão das consultoras ao `advisor_verdict`:** se confirma no protótipo de tom
  ([014](014-como-o-agente-soa.md)) e no ticket 033.

### Abriu

- [033 — Superfície das consultoras para o agente](033-superficie-das-consultoras-para-o-agente.md)
  — onde e como a consultora recebe o chamado, julga o atendimento e assume a conversa. Dá
  nitidez à névoa "Superfície para as consultoras" do mapa. Não reabre o
  [029](029-canal-de-notificacao-da-fila.md): e-mail via Apps Script continua sendo a
