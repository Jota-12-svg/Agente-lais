...
> **004** teve a planilha de clientes liberada mas segue aberto (falta catálogo do Maino e
> exemplos de planilha de arquiteto). Isso ainda bloqueia 011, 030 e 031.
...
| 010 | [O que é um lead qualificado e que dados o agente extrai](tickets/010-o-que-e-um-lead-qualificado.md) | grilling | agente não é formulário; campos núcleo + oportunistas, nada obrigatório; Supabase interno + relance na fila do 012; `Atendimento qualificado` no `CONTEXT.md` |
